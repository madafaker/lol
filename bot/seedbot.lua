...
function create_config( )
  ...
  config = {
    ...
    about_text = [[615🤖 is free 👻
➖➖➖➖➖➖➖➖➖➖➖
But if you want to have group with this bot 
Your group should be ➕1⃣0⃣0⃣
member 
Why ❓❗️
Because We  bring money by send propagandism in your group🌐
So if you agree with this 
Ask @nope_nope_nope to have group ✔️
Tnx
➖➖➖➖➖➖➖➖➖➖➖

Admin: wili ( @wilsone_developer )
Manager & designer : saber ( @mdsbr )
Channel: @campidea615
special tnx : @amir_sereen
]],
...
[!/]setphoto
برای تنظیم اسم و قفل کردن آن↙️
[!/]setname [name]
➖➖➖➖➖➖➖➖➖➖➖➖
...
[!/]blist
➖➖➖➖➖➖➖➖➖➖➖➖
درصورت داشتن هر گونه مشکل لینک گروه خود را برای سودو ها ارسال کنید↙️
[!/]615
➖➖➖➖➖➖➖➖➖➖➖➖
توضیحات بیشتر🤓
-تنها اونر ها و مدیر های گروه میتوانند ربات ادد کنند✅
-تنها اونر ها و مدیر ها میتوانند از کیک،بن،ان بن،لینک جدید،قفل عکس،اعضا و نام گروه و برداشتن قفل عکس،اعضا و نام گروه،قوانین ،توضیحات و تنظیمات گروه را دریافت کنند✅
تنها اونر ها میتوانند ازres ،setowner،promote،demoteو log استفاده کنند😊
Design by @vip_apps_admin
〰〰〰〰〰〰〰〰〰〰〰〰
]]
